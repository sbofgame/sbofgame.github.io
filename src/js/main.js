            ...
            questions: [
                {
                    result: null,
                    correctText: 'Верно!',
                    wrongText: 'Неверно!<p>Полностью автоматизированы пока только КБК и&nbsp;КВК.</p>'
                },
                {
                    result: null,
                    correctText: 'Правильно!',
                    wrongText: 'Неверно!<p>Простые кредиты выдаются даже когда ПСКО отдыхает.</p>'
                },
                {
                    result: null,
                    correctText: 'Правильно!',
                    wrongText: 'Неверно.<p>По&nbsp;ипотечным заявкам недвижимость регистрируется в&nbsp;СБОФ Ипотека.</p>'
                },
                {
                    result: null,
                    correctText: 'Верно!',
                    wrongText: 'Неверно!<p>Мы&nbsp;все автоматизировали.</p>'
                },
                {
                    result: null,
                    correctText: 'Верно!',
